...
def test_regression():
    ...
    #np.save(os.path.join(os.path.dirname(__file__),"../data/velocities_ref.npy"), vel)
    ...
    vel_ref = np.load(os.path.join(os.path.dirname(__file__), "../data/velocities_ref.npy"))
    ...
    np.testing.assert_allclose(vel, vel_ref, atol=0, rtol=1e-9, err_msg="for velocities")
